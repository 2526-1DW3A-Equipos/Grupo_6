...
<body>
      ...
      <nav class="cabeceraNav">
        <ul>
          ...
          <li>
            <a class="menuItem <?php if (
isset($pagina) && $pagina === 'inicio'
)
  echo 'isActive'; ?>" href="?inicio" data-page="inicio">Inicio</a>
          </li>
          <li>
            <a class="menuItem <?php if (isset($pagina) && $pagina === 'clasificacion')
  echo 'isActive'; ?>" href="?clasificacion" data-page="clasificacion">Clasificacion</a>
          </li>
          <li>
            <a class="menuItem <?php if (isset($pagina) && $pagina === 'calendario')
  echo 'isActive'; ?>" href="?calendario" data-page="calendario">Calendario</a>
          </li>
          <li>
            <a class="menuItem <?php if (isset($pagina) && $pagina === 'resultados')
  echo 'isActive'; ?>" href="?resultados" data-page="resultados">Resultados</a>
          </li>
          <li>
